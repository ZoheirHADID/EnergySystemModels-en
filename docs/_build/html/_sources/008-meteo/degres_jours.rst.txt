...
Avec ``base_chauffage`` = 18 °C et ``base_refroidissement`` = 23 °C by défaut,
...
(formule analogue for le rafraîchissement avec
...
``DJU_Rafraichissement`` sont ensuite sommées by mois (``df_month``) et par
année (``df_year``).
