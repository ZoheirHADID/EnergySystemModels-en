...
Le module IPMVP d'EnergySystemModels allows créer des models de baseline et de calculer les économies d'energy according to l'Option C.
...
* **y** : Consommation energy (série temporelle)
...
Le module IPMVP utilise la method du **z-score** :

.. math::

   z_i = \frac{y_i - \bar{y}}{\sigma_y}

Les points with :math:`|z|` > seuil (typiquement 3) sont considérés comme aberrants et exclus du model.
