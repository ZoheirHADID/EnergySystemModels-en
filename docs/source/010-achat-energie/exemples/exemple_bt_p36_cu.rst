...
**Contexte** : Un supermarche de taille moyenne raccorde en basse tension with une
power souscrite de 80 kW. Facturation mensuelle de janvier 2025.
...
.. figure:: ../../images/010_turpe_bt_p36_cu_plot.svg
   :alt: Supply TURPE Taxes Breakdown for the example BT above 36 kVA
   :align: center

   Répartition HTVA between fourniture, acheminement TURPE et taxes.

.. figure:: ../../images/010_turpe_bt_p36_cu_plot_detail.svg
   :alt: Bill Component Details for the example BT above 36 kVA
   :align: center
