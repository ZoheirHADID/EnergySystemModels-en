...
* ``pinch.plot_GCC()`` : grande courbe composite.
* ``pinch.plot_streams_and_temperature_intervals()`` : flux et intervalles.
* ``pinch.graphical_hen_design()`` : network d'échangeurs proposé.

.. figure:: ../images/006_pinch_plot_composites.svg
   :alt: Courbes composites real du cycle Pinch
   :align: center

   Output realle de ``pinch.plot_composites_curves()`` for les flux ci-dessus
   (generated by running the library) : composite chaude (bleu) et froide
...
Le network d'échangeurs optimal pourrait ressembler à :
...
.. figure:: ../images/006_pinch_distillation.svg
   :alt: Diagram Pinch for une unité de distillation
   :align: center
...
.. figure:: ../images/006_pinch_plot_composites.svg
   :alt: Aperçu des courbes composites for distillation
   :align: center
...
* Le rebouilleur requires toujours une utilité chaude (vapeur)
...
.. figure:: ../images/006_pinch_base.svg
   :alt: Diagram d'intégration Pinch with utilités multiples
   :align: center
...
* Les potential savings en remplaçant la vapeur HP by de la vapeur BP quand possible
...
.. figure:: ../images/006_pinch_sensibilite.svg
   :alt: Diagram d'analysis of sensibilité au ΔTmin
   :align: center
...
.. figure:: ../images/006_pinch_plot_sensibilite.svg
   :alt: Plot real de sensibilité Pinch au ΔTmin
   :align: center

   Output realle du balayage (generated by running the library) : de
...
3. **Interprétation des results**
   ...
   * Comparer les energy savings au coût d'investissement
