...
The module ``SolarSystem`` simulates the production photovoltaïque en utilisant pvlib-python et les data météo PVGIS.
...
* ``pv.df`` — Synthèse system (module, surface, production, productivité)
