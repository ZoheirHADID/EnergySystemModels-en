...
.. code-block:: python
   ...
   # 2. Merge with your consumption data
   df = df_month.copy()
   ...
   # Result DataFrames
   print(model.df_baseline)           # Data période baseline
   print(model.df_reporting)          # Data période reporting
   ...
   model.plot_baseline_fit()          # Baseline model fit
